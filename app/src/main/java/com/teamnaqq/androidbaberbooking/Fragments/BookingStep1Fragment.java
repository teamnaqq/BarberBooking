...
import com.teamnaqq.androidbaberbooking.Adapter.MySalonAdapter;
import com.teamnaqq.androidbaberbooking.Common.Common;
import com.teamnaqq.androidbaberbooking.Common.SpacesItemDecoration;
import com.teamnaqq.androidbaberbooking.Interface.IAllSalonLoadListener;
import com.teamnaqq.androidbaberbooking.Interface.IBranchLoadListener;
        ...
        allSalonRef.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    list.add("Vui lòng chọn thành phố");
