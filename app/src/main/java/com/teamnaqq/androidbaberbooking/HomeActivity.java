...
import com.teamnaqq.androidbaberbooking.Fragments.ServiceFragment;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Homeeee";
    ...
    private void showUpdateDialog(final String phoneNumber) {
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final User user = new User(name, address
                        ,
                        phoneNumber);
                    ...
                    userRef.document(phoneNumber)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(HomeActivity.this, "Cảm ơn!", Toast.LENGTH_SHORT).show();
                                }
